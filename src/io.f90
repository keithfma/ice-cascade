...
if (infile=='egholm1a') pBenchmark = 9 ! Egholm 1 benchmark, 0ky (Egholm '11, Geomorphology)
if (infile=='egholm1b') pBenchmark = 10 ! Egholm 1 benchmark, 5ky (Egholm '11, Geomorphology)
if (infile=='egholm1c') pBenchmark = 11 ! Egholm 1 benchmark, 10ky (Egholm '11, Geomorphology)
if (infile=='egholm1d') pBenchmark = 12 ! Egholm 1 benchmark, 15ky (Egholm '11, Geomorphology)
if (infile=='egholm2a') pBenchmark = 13 ! Egholm 2 benchmark, 0ky (Egholm '11, Geomorphology)
if (infile=='egholm2b') pBenchmark = 14 ! Egholm 2 benchmark, 5ky (Egholm '11, Geomorphology)
if (infile=='egholm2c') pBenchmark = 15 ! Egholm 2 benchmark, 10ky (Egholm '11, Geomorphology)
if (infile=='egholm2d') pBenchmark = 16 ! Egholm 2 benchmark, 15ky (Egholm '11, Geomorphology)
